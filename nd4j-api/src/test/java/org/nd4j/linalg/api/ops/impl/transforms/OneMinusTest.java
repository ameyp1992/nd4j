...
/**
 * The class <code>OneMinusTest</code> contains tests for the class <code>{@link OneMinus}</code>.
 *
...
public class OneMinusTest {
	/**
	 * Run the OneMinus(INDArray) constructor test.
	 *
	 * @throws Exception
	 *
	 * @generatedBy CodePro at 3/7/15 7:09 PM
	 */
	@Test
	public void testOneMinus_1()
		throws Exception {
		INDArray x = null;

		OneMinus result = new OneMinus(x);
		...
		//       at org.nd4j.linalg.api.ops.impl.transforms.OneMinus.<init>(OneMinus.java:44)
		assertNotNull(result);
	}

	/**
	 * Run the OneMinus(INDArray,INDArray) constructor test.
	 *
	 * @throws Exception
	 *
	 * @generatedBy CodePro at 3/7/15 7:09 PM
	 */
	@Test
	public void testOneMinus_2()
		throws Exception {
		INDArray x = null;
		INDArray z = null;

		OneMinus result = new OneMinus(x, z);
		...
		//       at org.nd4j.linalg.api.ops.impl.transforms.OneMinus.<init>(OneMinus.java:32)
		assertNotNull(result);
	}

	/**
	 * Run the OneMinus(INDArray,INDArray,int) constructor test.
	 *
	 * @throws Exception
	 *
	 * @generatedBy CodePro at 3/7/15 7:09 PM
	 */
	@Test
	public void testOneMinus_3()
		throws Exception {
		INDArray x = null;
		INDArray z = null;
		int n = 1;

		OneMinus result = new OneMinus(x, z, n);

		// add additional test code here
		assertNotNull(result);
		assertEquals("oneminus", result.name());
		assertEquals(null, result.z());
		assertEquals(null, result.y());
		assertEquals(1, result.n());
		assertEquals("oneminus", result.toString());
	...
	/**
	 * Run the OneMinus(INDArray,INDArray,INDArray,int) constructor test.
	 *
	 * @throws Exception
	 *
	 * @generatedBy CodePro at 3/7/15 7:09 PM
	...
	public void testOneMinus_4()
		...
		OneMinus result = new OneMinus(x, y, z, n);
	...
	public void testName_1()
		throws Exception {
		OneMinus fixture = new OneMinus((INDArray) null);
	...
	public static void main(String[] args) {
		new org.junit.runner.JUnitCore().run(OneMinusTest.class);
	}
}