...
/**
 * The class <code>ScalarSubtractionTest</code> contains tests for the class <code>{@link ScalarSubtraction}</code>.
 *
 * @generatedBy CodePro at 3/7/15 7:09 PM
 * @author saurabh
 * @version $Revision: 1.0 $
 */
public class ScalarSubtractionTest {
	/**
	 * Run the ScalarSubtraction(INDArray,Number) constructor test.
	 *
	 * @throws Exception
	 *
	 * @generatedBy CodePro at 3/7/15 7:09 PM
	 */
	@Test
	public void testScalarSubtraction_1()
		throws Exception {
		INDArray x = null;
		Number num = new Byte((byte) 1);

		ScalarSubtraction result = new ScalarSubtraction(x, num);
		...
		//       at org.nd4j.linalg.api.ops.impl.scalar.ScalarSubtraction.<init>(ScalarSubtraction.java:34)
		assertNotNull(result);
	}

	/**
	 * Run the ScalarSubtraction(INDArray,IComplexNumber) constructor test.
	 *
	 * @throws Exception
	 *
	 * @generatedBy CodePro at 3/7/15 7:09 PM
	 */
	@Test
	public void testScalarSubtraction_2()
		throws Exception {
		INDArray x = null;
		...
		//       at org.nd4j.linalg.api.ops.impl.scalar.ScalarSubtraction.<init>(ScalarSubtraction.java:42)
		assertNotNull(result);
	}

	/**
	 * Run the ScalarSubtraction(INDArray,INDArray,INDArray,int,Number) constructor test.
	 *
	 * @throws Exception
	 *
	 * @generatedBy CodePro at 3/7/15 7:09 PM
	 */
	@Test
	public void testScalarSubtraction_3()
		throws Exception {
		INDArray x = null;
		INDArray y = null;
		INDArray z = null;
		...
		ScalarSubtraction result = new ScalarSubtraction(x, y, z, n, num);

		// add additional test code here
		assertNotNull(result);
		assertEquals("sub_scalar", result.name());
		...
		assertEquals("sub_scalar", result.toString());
	...
	/**
	 * Run the ScalarSubtraction(INDArray,INDArray,INDArray,int,IComplexNumber) constructor test.
	 *
	 * @throws Exception
	 *
	 * @generatedBy CodePro at 3/7/15 7:09 PM
	 */
	@Test
	public void testScalarSubtraction_4()
		throws Exception {
		INDArray x = null;
		INDArray y = null;
		INDArray z = null;
	...
	public void testName_1()
		throws Exception {
		ScalarSubtraction fixture = new ScalarSubtraction((INDArray) null, new Byte((byte) 1));
	...
	public static void main(String[] args) {
		new org.junit.runner.JUnitCore().run(ScalarSubtractionTest.class);
	}
}