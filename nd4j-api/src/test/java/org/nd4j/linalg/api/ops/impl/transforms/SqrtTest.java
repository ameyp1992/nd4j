...
public class SqrtTest {
	/**
	 * Run the Sqrt(INDArray) constructor test.
	 *
	 * @throws Exception
	 *
	 * @generatedBy CodePro at 3/7/15 7:10 PM
	...
	/**
	 * Run the Sqrt(INDArray,INDArray) constructor test.
	 *
	 * @throws Exception
	 *
	 * @generatedBy CodePro at 3/7/15 7:10 PM
	...
	public void testSqrt_2()
		...
		//       at org.nd4j.linalg.api.ops.impl.transforms.Sqrt.<init>(Sqrt.java:33)
		assertNotNull(result);
	}

	/**
	 * Run the Sqrt(INDArray,INDArray,int) constructor test.
	 *
	 * @throws Exception
	 *
	 * @generatedBy CodePro at 3/7/15 7:10 PM
	...
	public void testSqrt_3()
		...
		Sqrt result = new Sqrt(x, z, n);

		// add additional test code here
		assertNotNull(result);
		assertEquals("sqrt", result.name());
		assertEquals(null, result.z());
		assertEquals(null, result.y());
		assertEquals(1, result.n());
		assertEquals("sqrt", result.toString());
	...
	/**
	 * Run the Sqrt(INDArray,INDArray,INDArray,int) constructor test.
	 *
	 * @throws Exception
	 *
	 * @generatedBy CodePro at 3/7/15 7:10 PM
	...
	public void testName_1()
		throws Exception {
		Sqrt fixture = new Sqrt((INDArray) null);
