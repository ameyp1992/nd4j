...
/**
 * The class <code>AndTest</code> contains tests for the class <code>{@link And}</code>.
 *
...
public class AndTest {
	/**
	 * Run the And(Condition[]) constructor test.
	 *
	 * @throws Exception
	 *
	 * @generatedBy CodePro at 3/7/15 7:13 PM
	...
	public void testApply_1()
		throws Exception {
		And fixture = new And(new Condition[] {});
		...
		//       at org.nd4j.linalg.indexing.conditions.And.apply(And.java:34)
		assertNotNull(result);
	}
	...
	public void testApply_5()
		...
		// An unexpected exception was thrown in user code while executing this test:
		//    java.lang.ArrayIndexOutOfBoundsException: 0
		//       at org.nd4j.linalg.indexing.conditions.And.apply(And.java:46)
		assertNotNull(result);
	}
	...
	public static void main(String[] args) {
		new org.junit.runner.JUnitCore().run(AndTest.class);
	}
}