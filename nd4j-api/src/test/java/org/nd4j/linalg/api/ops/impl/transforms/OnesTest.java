...
/**
 * The class <code>OnesTest</code> contains tests for the class <code>{@link Ones}</code>.
 *
...
public class OnesTest {
	/**
	 * Run the Ones(INDArray) constructor test.
	 *
	 * @throws Exception
	 *
	 * @generatedBy CodePro at 3/7/15 7:09 PM
	...
	public void testOnes_1()
		...
		//       at org.nd4j.linalg.api.ops.impl.transforms.Ones.<init>(Ones.java:44)
		assertNotNull(result);
	}

	/**
	 * Run the Ones(INDArray,INDArray) constructor test.
	 *
	 * @throws Exception
	 *
	 * @generatedBy CodePro at 3/7/15 7:09 PM
	...
	public void testOnes_2()
		...
		//       at org.nd4j.linalg.api.ops.impl.transforms.Ones.<init>(Ones.java:32)
		assertNotNull(result);
	}

	/**
	 * Run the Ones(INDArray,INDArray,int) constructor test.
	 *
	 * @throws Exception
	 *
	 * @generatedBy CodePro at 3/7/15 7:09 PM
	...
	public void testOnes_3()
		...
		Ones result = new Ones(x, z, n);

		// add additional test code here
		assertNotNull(result);
		assertEquals("ones", result.name());
		assertEquals(null, result.z());
		assertEquals(null, result.y());
		assertEquals(1, result.n());
		assertEquals("ones", result.toString());
	...
	/**
	 * Run the Ones(INDArray,INDArray,INDArray,int) constructor test.
	 *
	 * @throws Exception
	 *
	 * @generatedBy CodePro at 3/7/15 7:09 PM
	...
	public void testName_1()
		throws Exception {
		Ones fixture = new Ones((INDArray) null);
	...
	public static void main(String[] args) {
		new org.junit.runner.JUnitCore().run(OnesTest.class);
	}
}