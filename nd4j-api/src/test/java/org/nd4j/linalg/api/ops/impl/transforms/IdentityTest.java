...
public class IdentityTest {
	/**
	 * Run the Identity(INDArray) constructor test.
	 *
	 * @throws Exception
	 *
	 * @generatedBy CodePro at 3/7/15 7:10 PM
	...
	public void testIdentity_1()
		...
		Identity result = new Identity(x);
	...
	/**
	 * Run the Identity(INDArray,INDArray) constructor test.
	 *
	 * @throws Exception
	 *
	 * @generatedBy CodePro at 3/7/15 7:10 PM
	...
	public void testIdentity_2()
		...
		Identity result = new Identity(x, z);
		...
		//       at org.nd4j.linalg.api.ops.impl.transforms.Identity.<init>(Identity.java:31)
		assertNotNull(result);
	}

	/**
	 * Run the Identity(INDArray,INDArray,int) constructor test.
	 *
	 * @throws Exception
	 *
	 * @generatedBy CodePro at 3/7/15 7:10 PM
	...
	public void testIdentity_3()
		...
		Identity result = new Identity(x, z, n);

		// add additional test code here
		assertNotNull(result);
		assertEquals("identity", result.name());
		assertEquals(null, result.z());
		assertEquals(null, result.y());
		assertEquals(1, result.n());
		assertEquals("identity", result.toString());
	...
	/**
	 * Run the Identity(INDArray,INDArray,INDArray,int) constructor test.
	 *
	 * @throws Exception
	 *
	 * @generatedBy CodePro at 3/7/15 7:10 PM
	...
	public void testIdentity_4()
		...
		Identity result = new Identity(x, y, z, n);
	...
	public void testName_1()
		throws Exception {
		Identity fixture = new Identity((INDArray) null);
