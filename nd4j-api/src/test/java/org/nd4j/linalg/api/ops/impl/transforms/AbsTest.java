...
/**
 * The class <code>AbsTest</code> contains tests for the class <code>{@link Abs}</code>.
 *
...
public class AbsTest {
	/**
	 * Run the Abs(INDArray) constructor test.
	 *
	 * @throws Exception
	 *
	 * @generatedBy CodePro at 3/7/15 7:10 PM
	...
	/**
	 * Run the Abs(INDArray,INDArray) constructor test.
	 *
	 * @throws Exception
	 *
	 * @generatedBy CodePro at 3/7/15 7:10 PM
	...
	public void testAbs_2()
		...
		//       at org.nd4j.linalg.api.ops.impl.transforms.Abs.<init>(Abs.java:32)
		assertNotNull(result);
	}

	/**
	 * Run the Abs(INDArray,INDArray,int) constructor test.
	 *
	 * @throws Exception
	 *
	 * @generatedBy CodePro at 3/7/15 7:10 PM
	...
	/**
	 * Run the Abs(INDArray,INDArray,INDArray,int) constructor test.
	 *
	 * @throws Exception
	 *
	 * @generatedBy CodePro at 3/7/15 7:10 PM
	...
	public void testName_1()
		throws Exception {
		Abs fixture = new Abs((INDArray) null);
	...
	public static void main(String[] args) {
		new org.junit.runner.JUnitCore().run(AbsTest.class);
	}
}