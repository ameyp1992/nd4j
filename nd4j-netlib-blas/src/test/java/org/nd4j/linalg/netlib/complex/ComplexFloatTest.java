...
public class ComplexFloatTest {
	...
	public void testAdd_2()
		...
		assertEquals(false, result.isReal());
		assertEquals(new Float(1.0f), result.imaginaryComponent());
		assertEquals(new Float(2.236068f), result.absoluteValue());
		assertEquals(new Float(-2.0f), result.realComponent());
		assertEquals(false, result.isImag());
	}
	...
	public void testAdd_4()
		...
		assertEquals(true, result.isReal());
		assertEquals(new Float(0.0f), result.imaginaryComponent());
		assertEquals(new Float(2.0f), result.absoluteValue());
		assertEquals(new Float(-2.0f), result.realComponent());
		assertEquals(false, result.isImag());
	}
	...
	public void testAddi_6()
		...
		assertEquals(new Double(2.23606797749979), result2.absoluteValue());
		assertEquals(new Double(-2.0), result2.realComponent());
		assertEquals(false, result2.isImag());
	}
	...
	public void testAddi_7()
		...
		assertEquals(new Float(2.236068f), result2.absoluteValue());
		assertEquals(new Float(-2.0f), result2.realComponent());
		assertEquals(false, result2.isImag());
	}
	...
	public void testGt_1()
		...
		assertEquals(true, result.isReal());
		assertEquals(new Float(0.0f), result.imaginaryComponent());
		assertEquals(new Float(0.0f), result.absoluteValue());
	...
	public void testRsubi_3()
		...
		assertEquals(true, result2.isReal());
		assertEquals(new Double(0.0), result2.imaginaryComponent());
		assertEquals(new Double(0.0), result2.absoluteValue());
