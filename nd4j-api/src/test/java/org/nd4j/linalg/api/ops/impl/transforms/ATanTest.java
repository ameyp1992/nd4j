...
/**
 * The class <code>ATanTest</code> contains tests for the class <code>{@link ATan}</code>.
 *
...
public class ATanTest {
	/**
	 * Run the ATan(INDArray) constructor test.
	 *
	 * @throws Exception
	 *
	 * @generatedBy CodePro at 3/7/15 7:09 PM
	 */
	@Test
	public void testATan_1()
		throws Exception {
		INDArray x = null;

		ATan result = new ATan(x);
		...
		//       at org.nd4j.linalg.api.ops.impl.transforms.ATan.<init>(ATan.java:45)
		assertNotNull(result);
	}

	/**
	 * Run the ATan(INDArray,INDArray) constructor test.
	 *
	 * @throws Exception
	 *
	 * @generatedBy CodePro at 3/7/15 7:09 PM
	 */
	@Test
	public void testATan_2()
		throws Exception {
		INDArray x = null;
		INDArray z = null;

		ATan result = new ATan(x, z);
		...
		//       at org.nd4j.linalg.api.ops.impl.transforms.ATan.<init>(ATan.java:33)
		assertNotNull(result);
	}

	/**
	 * Run the ATan(INDArray,INDArray,int) constructor test.
	 *
	 * @throws Exception
	 *
	 * @generatedBy CodePro at 3/7/15 7:09 PM
	 */
	@Test
	public void testATan_3()
		throws Exception {
		INDArray x = null;
		INDArray z = null;
		int n = 1;

		ATan result = new ATan(x, z, n);

		// add additional test code here
		assertNotNull(result);
		assertEquals("atan", result.name());
		assertEquals(null, result.z());
		assertEquals(null, result.y());
		assertEquals(1, result.n());
		assertEquals("atan", result.toString());
	...
	/**
	 * Run the ATan(INDArray,INDArray,INDArray,int) constructor test.
	 *
	 * @throws Exception
	 *
	 * @generatedBy CodePro at 3/7/15 7:09 PM
	...
	public void testName_1()
		throws Exception {
		ATan fixture = new ATan((INDArray) null);
	...
	public static void main(String[] args) {
		new org.junit.runner.JUnitCore().run(ATanTest.class);
	}
}